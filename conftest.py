...
_UNIT_TESTS = [
    ...
    'acouchbase_operational_insights/tests/logging_t.py::LogPrefixTests',
    ...
    'couchbase_operational_insights/tests/logging_t.py::LogPrefixTests',
    'couchbase_operational_insights/tests/logging_t.py::LoggingTests',
