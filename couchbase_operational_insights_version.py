...
VERSION_FILE = os.path.join(os.path.dirname(__file__), 'couchbase_operational_insights', '_version.py')
...
def gen_version(
    ...
    couchbase_operational_insights/_version.py file. If not inside a git tree it will
