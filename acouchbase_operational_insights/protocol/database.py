...
from acouchbase_operational_insights.protocol.scope import AsyncScope
...
class AsyncDatabase:
    ...
    def name(self) -> str:
        """
        str: The name of this :class:`~acouchbase_operational_insights.protocol.database.Database` instance.
        """
