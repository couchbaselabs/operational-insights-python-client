...
class AsyncCluster:
    ...
    Args:
        ...
        **kwargs: keyword arguments that can be used in place or to overrride provided :class:`~acouchbase_operational_insights.options.ClusterOptions`
    ...
    def __init__(
        ...
        from acouchbase_operational_insights.protocol.cluster import AsyncCluster as _AsyncCluster
    ...
    def database(self, name: str) -> AsyncDatabase:
        ...
        .. seealso::
            :class:`~acouchbase_operational_insights.database.AsyncDatabase`
    ...
    def execute_query(self, statement: str, *args: object, **kwargs: object) -> Awaitable[AsyncQueryResult]:
        ...
        .. seealso::
            :meth:`acouchbase_operational_insights.AsyncScope.execute_query`: For how to execute scope-level queries.
    ...
    def start_query(self, statement: str, *args: object, **kwargs: object) -> Awaitable[AsyncQueryHandle]:
        ...
        .. seealso::
            :meth:`acouchbase_operational_insights.Scope.start_query`: For how to execute scope-level queries.
    ...
    def create_instance(
        ...
        Examples:
            ...
            Initialize cluster using with global timeout options::
                ...
                from acouchbase_operational_insights import get_event_loop
                from acouchbase_operational_insights.cluster import AsyncCluster
                from acouchbase_operational_insights.credential import Credential
                from acouchbase_operational_insights.options import ClusterOptions, ClusterTimeoutOptions
