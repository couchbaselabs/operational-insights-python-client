...
class Scope:
    ...
    The Scope instance exposes the operations which are available to be performed against an Operational Insights scope.

    Args:
        database (:class:`~couchbase_operational_insights.database.Database`): A :class:`~couchbase_operational_insights.database.Database` instance.
        scope_name (str): The scope name.

    """  # noqa: E501

    def __init__(self, database: Database, scope_name: str) -> None:
        from couchbase_operational_insights.protocol.scope import Scope as _Scope
    ...
    def name(self) -> str:
        """
        str: The name of this :class:`~couchbase_operational_insights.scope.Scope` instance.
        """
    ...
    def execute_query(
        ...
        .. seealso::
            * :meth:`couchbase_operational_insights.Cluster.execute_query`: For how to execute cluster-level queries.
    ...
    def start_query(self, statement: str, *args: object, **kwargs: object) -> BlockingQueryHandle:
        ...
        .. seealso::
            :meth:`couchbase_operational_insights.Cluster.start_query`: For how to execute cluster-level queries.
