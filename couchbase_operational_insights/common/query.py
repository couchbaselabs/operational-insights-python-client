...
from couchbase_operational_insights.common._core.query import QueryMetadataCore, QueryMetricsCore, QueryWarningCore
...
class QueryMetadata:
    ...
    def metrics(self) -> QueryMetrics:
        ...
        Returns:
            A :class:`~couchbase_operational_insights.query.QueryMetrics` instance.
        """
