...
class OperationalInsightsError(Exception):
    """
    Generic base error.  Operational Insights specific errors inherit from this base error.
    """
...
class InvalidCredentialError(OperationalInsightsError):
    """
...
class QueryError(OperationalInsightsError):
    """
    Indicates that an query request received an error from the Operational Insights server.
    """
    ...
    def code(self) -> int:
        """
        Returns:
            Error code from Operational Insights server
        """
        return self._code
    ...
    def server_message(self) -> str:
        """
        Returns:
            Error message from Operational Insights server
        """
...
class QueryNotFoundError(OperationalInsightsError):
    """
...
class TimeoutError(OperationalInsightsError):
    """
