...
from couchbase_operational_insights.database import Database
...
class Cluster:
    ...
    Args:
        endpoint:
            The endpoint to use for sending HTTP requests to the Operational Insights server.
        ...
        **kwargs: keyword arguments that can be used in place or to overrride provided :class:`~couchbase_operational_insights.options.ClusterOptions`
    ...
    def __init__(
        ...
        from couchbase_operational_insights.protocol.cluster import Cluster as _Cluster
    ...
    def database(self, name: str) -> Database:
        ...
        .. seealso::
            :class:`~couchbase_operational_insights.database.Database`
    ...
    def execute_query(
        ...
        .. seealso::
            :meth:`couchbase_operational_insights.Scope.execute_query`: For how to execute scope-level queries.

        Args:
            statement: The SQL++ statement to execute.
            options (:class:`~couchbase_operational_insights.options.QueryOptions`): Optional parameters for the query operation.
            **kwargs (Dict[str, Any]): keyword arguments that can be used in place or to override provided :class:`~couchbase_operational_insights.options.QueryOptions`

        Returns:
            :class:`~couchbase_operational_insights.result.BlockingQueryResult`: An instance of a :class:`~couchbase_operational_insights.result.BlockingQueryResult` which
    ...
    def start_query(self, statement: str, *args: object, **kwargs: object) -> BlockingQueryHandle:
        """Executes a query against an Operational Insights cluster in async mode.

        .. seealso::
            :meth:`couchbase_operational_insights.Scope.start_query`: For how to execute scope-level queries.

        Args:
            statement: The SQL++ statement to execute.
            options (:class:`~couchbase_operational_insights.options.StartQueryOptions`): Optional parameters for the query operation.
            **kwargs (Dict[str, Any]): keyword arguments that can be used in place or to override provided :class:`~couchbase_operational_insights.options.StartQueryOptions`

        Returns:
            :class:`~couchbase_operational_insights.query_handle.BlockingQueryHandle`: An instance of a :class:`~couchbase_operational_insights.query_handle.BlockingQueryHandle`
        """  # noqa: E501
    ...
    def create_instance(
        ...
        Returns:
            An Operational Insights Cluster instance.
        ...
        Examples:
            ...
            Initialize cluster using with global timeout options::
                ...
                from couchbase_operational_insights.cluster import Cluster
                from couchbase_operational_insights.credential import Credential
                from couchbase_operational_insights.options import ClusterOptions, ClusterTimeoutOptions
