...
from couchbase_operational_insights.protocol.scope import Scope
...
class Database:
    ...
    def name(self) -> str:
        """
        str: The name of this :class:`~couchbase_operational_insights.protocol.database.Database` instance.
        """
