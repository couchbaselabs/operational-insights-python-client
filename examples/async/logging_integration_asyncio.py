...
"""Routing the SDK's logs into an application's own logging setup (async API).
...
SDK's logger and set the level.  The async API logs to its own logger, named after its package.
"""
...
from acouchbase_operational_insights import LOG_DATE_FORMAT, LOG_FORMAT, LOGGER_NAME
...
def configure_application_logging() -> None:
    ...
    # LOGGER_NAME is 'acouchbase_operational_insights'.
